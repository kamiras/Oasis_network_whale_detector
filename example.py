...
mycursor.execute("CREATE TABLE datos (oasis_from VARCHAR(255), amount DECIMAL(32,2), time VARCHAR(16))")
...
val = ("oasis1qzwfdgpt3p6dd2mk6207qhf9qrxuvfn9eunurdgu", "4867.90", "10:58:07")
mycursor.execute(sql, val)

mydb.commit()

sql = "INSERT INTO datos (oasis_from, amount, time) VALUES (%s, %s, %s)"
val = ("oasis1qzwfdgpt3p6dd2mk6207qhf9qrxuvfn9eunurdgu", "3867.90", "10:58:10")
mycursor.execute(sql, val)
